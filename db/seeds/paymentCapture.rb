...
ToteItem.create(quantity: 10, price: 2.75, status: ToteItem.states[:ADDED], user_id: 8, posting_id: 1)
ToteItem.create(quantity: 5, price: 2.75, status: ToteItem.states[:ADDED], user_id: 6, posting_id: 1)
ToteItem.create(quantity: 40, price: 2.75, status: ToteItem.states[:ADDED], user_id: 5, posting_id: 1)

#Milk
ToteItem.create(quantity: 5, price: 12, status: ToteItem.states[:ADDED], user_id: 7, posting_id: 3)
ToteItem.create(quantity: 2, price: 12, status: ToteItem.states[:ADDED], user_id: 8, posting_id: 3)
ToteItem.create(quantity: 3, price: 12, status: ToteItem.states[:ADDED], user_id: 6, posting_id: 3)
ToteItem.create(quantity: 1, price: 12, status: ToteItem.states[:ADDED], user_id: 5, posting_id: 3)

#Chicken
ToteItem.create(quantity: 1, price: 20, status: ToteItem.states[:ADDED], user_id: 7, posting_id: 6)
ToteItem.create(quantity: 4, price: 20, status: ToteItem.states[:ADDED], user_id: 8, posting_id: 6)
ToteItem.create(quantity: 10, price: 20, status: ToteItem.states[:ADDED], user_id: 6, posting_id: 6)
ToteItem.create(quantity: 15, price: 20, status: ToteItem.states[:ADDED], user_id: 5, posting_id: 6)

#Celery
ToteItem.create(quantity: 5, price: 2.5, status: ToteItem.states[:ADDED], user_id: 7, posting_id: 8)
ToteItem.create(quantity: 6, price: 2.5, status: ToteItem.states[:ADDED], user_id: 8, posting_id: 8)
ToteItem.create(quantity: 3, price: 2.5, status: ToteItem.states[:ADDED], user_id: 6, posting_id: 8)
ToteItem.create(quantity: 10, price: 2.5, status: ToteItem.states[:ADDED], user_id: 5, posting_id: 8)