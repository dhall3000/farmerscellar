...
#Apples
ToteItem.create(quantity: 2, price: 2.75, status: ToteItem.states[:COMMITTED], user_id: 6, posting_id: 1)
...
#Milk
ToteItem.create(quantity: 5, price: 12, status: ToteItem.states[:COMMITTED], user_id: 6, posting_id: 3)
...
#Chicken
ToteItem.create(quantity: 1, price: 12, status: ToteItem.states[:COMMITTED], user_id: 6, posting_id: 6)
