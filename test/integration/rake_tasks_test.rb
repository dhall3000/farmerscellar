    ...
    14400.times do
      ...
      if top_of_hour
        ...
        if Time.zone.now == @p1.order_cutoff
          ...
          subject = "Order for #{@p1.delivery_date.strftime("%A, %B")} #{@p1.delivery_date.day.ordinalize} delivery"
          ...
          assert_equal 1, email_count
          subject = "Order for #{@p2.delivery_date.strftime("%A, %B")} #{@p2.delivery_date.day.ordinalize} delivery"
          ...
          assert_equal 3, committed_tote_item_count
          assert_equal 1, email_count
          subject = "Order for #{@p3.delivery_date.strftime("%A, %B")} #{@p3.delivery_date.day.ordinalize} delivery"
          ...
          assert_equal 1, email_count
          subject = "Order for #{@p4.delivery_date.strftime("%A, %B")} #{@p4.delivery_date.day.ordinalize} delivery"
