Rails.application.configure do
  ...
  config.after_initialize do
    ...
    ::NOPRODUCTIMAGETITLE = ENV['NO_PRODUCT_IMAGE_TITLE']
    ::LANDINGSPLASHTITLE = ENV['LANDINGSPLASHTITLE']
    ::HEADERICONTITLE = ENV['HEADERICONTITLE']
    ::PRODUCERDEFAULTPASSWORD = ENV['PRODUCER_DEFAULT_PASSWORD']
